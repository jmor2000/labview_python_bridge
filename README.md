...
The 'Your-Python-App' deploys a 'Global Queue Service' to run in parrallel to itself on startup. </br>
This 'Global Queue Service' hosts two data queues (In & Out) which can be accessed using the python "Lbv_Global_Que" class.</br>
'Your-Labview-App' connects to the 'Global Queue Service' and accesses the data queses by creating and interactive with "Lbv_Global_Que" class object.</br>
